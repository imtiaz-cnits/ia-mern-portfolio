...
router.get("/PortfolioDetails/:PortfolioID",  PortfolioController.PortfolioDetails);
router.get("/PortfolioListByCategory/:CategoryID",  PortfolioController.PortfolioListByCategory);
router.post("/PortfolioUpdate/:PortfolioID",  PortfolioController.PortfolioUpdate);
router.post("/PortfolioDelete/:PortfolioID",  PortfolioController.PortfolioDelete);

// Portfolio Category
router.post("/PortfolioCategoryCreate",  PortfolioController.PortfolioCategoryCreate);
router.get("/PortfolioCategoryList",  PortfolioController.PortfolioCategoryList);
router.post("/PortfolioCategoryUpdate/:CategoryID",  PortfolioController.PortfolioCategoryUpdate);
router.post("/PortfolioCategoryDelete/:CategoryID",  PortfolioController.PortfolioCategoryDelete);
...
router.post("/BlogCategoryUpdate/:CategoryID",  BlogController.BlogCategoryUpdate);
router.post("/BlogCategoryDelete/:CategoryID",  BlogController.BlogCategoryDelete);
