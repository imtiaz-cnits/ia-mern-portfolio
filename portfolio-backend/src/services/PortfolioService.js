...
const PortfolioListService = async (req, res) => {
    try {
        const JoinWithCategoryStage = {$lookup: {from: "portfolio_categories", localField: "portfolio_category_id", foreignField: "_id", as: "portfolio_category"}};
        ...
        const ProjectionStage = {$project: { "portfolio_category_id": 0, "client_id": 0}};
...
const PortfolioListByCategoryService = async (req, res) => {
    try {
        ...
        const MatchStage = {$match: {portfolio_category_id: category_id}};
        const JoinWithCategoryStage = {$lookup: {from: "portfolio_categories", localField: "portfolio_category_id", foreignField: "_id", as: "portfolio_category"}};
        const UnwindCategoryStage = {$unwind: "$portfolio_category"};
        const ProjectionStage = {$project: { "portfolio_category_id": 0, "client_id": 0}};
...
const PortfolioCategoryCreateService = async (req, res) => {
    try {
        ...
        return {status: "success", message: "Portfolio Category Created Successful"};
    } catch (e) {
        return {status: "fail", message: "Something Went Wrong!"};
    }
}
...
const PortfolioCategoryUpdateService = async (req, res) => {
    try {
        ...
        let reqBody = req.body;
        await PortfolioCategoryModel.updateOne({_id: category_id}, {$set: reqBody});
        return {status: "success", message: "Portfolio Category Updated Successful"};
    } catch (e) {
        return {status: "fail", message: "Something Went Wrong!"};
    }
}
...
const PortfolioCategoryDeleteService = async (req, res) => {
    try {
        ...
        return {status: "success", message: "Portfolio Category Deleted Successful"};
    } catch (e) {
        return {status: "fail", message: "Something Went Wrong!"};
    }
}
